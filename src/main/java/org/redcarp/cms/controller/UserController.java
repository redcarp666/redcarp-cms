...
import org.redcarp.cms.service.UserService;
...
public class UserController {
	...
	@PostMapping
	public List<User> addNewUser(@RequestAttribute String USER_ROLE, @RequestBody User user) {
		return userService.addNewUser(USER_ROLE, user);
	}

	@PutMapping
	public List<User> updateUser(@RequestAttribute String USER_ROLE, @RequestBody User user) {
		return userService.updateUser(USER_ROLE, user);
	}

	@DeleteMapping
	public List<User> deleteUser(@RequestAttribute String USER_ROLE, @RequestParam String username) {
	...
	public User updateSelfInfo(@RequestAttribute String USER_ROLE, @RequestBody User user) {
	...
	public User resetPassword(@RequestAttribute String USER_ROLE, @RequestBody User user) {
