...
import org.redcarp.cms.service.ArticleService;
...
public class ArticleController {
	...
	@PostMapping
	public Article newArticle(@RequestAttribute String USER_ROLE, @RequestBody Article article) {
		return articleService.newArticle(USER_ROLE, article);
	}

	@PutMapping
	public Article updateArticle(@RequestAttribute String USER_ROLE, @RequestBody Article article) {
		return articleService.updateArticle(USER_ROLE, article);
	}

	@DeleteMapping
	public void deleteArticle(@RequestAttribute String USER_ROLE, @RequestParam Integer articleId) {
	...
	public List<Article> getArticlesByConditions(@RequestParam String status, @RequestParam String selectedDate, @RequestParam String selectedCategory, @RequestParam String selectedTag) {
	...
	public Article moveToRecycleBin(@RequestAttribute String USER_ROLE, @RequestParam Boolean beDelete, @RequestBody Article article) {
